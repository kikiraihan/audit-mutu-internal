            ...
            <div>
                <div class="bg-gray-200 px-4 py-4">
                    <div class="w-full md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
                        <div>
                            <a href="{{ route('base') }}" class="inline-block py-2 text-gray-800 text-2xl font-bold">UMI-UNG</a>
                        </div>
                    ...
                    <div class="px-4 py-16">
                        <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                            <h1 class="font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6">
                                Audit Mutu Internal Universitas Negeri Gorontalo
                            </h1>
                ...
                <div class="max-w-4xl mx-auto bg-white shadow-lg relative z-20 hidden md:block"
                    ...
                    <div class="h-20 w-20 rounded-full bg-yellow-500 absolute top-0 left-0 -ml-10 -mt-10" style="z-index: -1;">
                    </div>
                                ...
                                <div class="w-1/3 px-4">
                                    <div class="rounded-lg shadow-lg p-6">
                                        ...
                                        <svg height="150" width="150" viewBox="0 0 20 20" class="mx-auto mb-12">
                                            ...
                                            <circle r="5" cx="10" cy="10" fill="transparent" stroke="#2b6cb0" stroke-width="10"
                                                stroke-dasharray="11 31.4" transform="rotate(-90) translate(-20)" />
                                        </svg>
