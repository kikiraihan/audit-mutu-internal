    ...
    <main class="w-full flex-grow p-6">
        ...
        <section class="w-full">
                ...
                <div class="bg-white overflow-auto mb-6 py-3 px-6 rounded text-justify">
                    ...
                    <div class="flex border-b border-40">
                        <div class="w-1/4 py-4">
                            <h4 class="font-normal text-80">Lokasi audit</h4>
                        </div>
                        <div class="w-3/4 py-4 break-words">
                            <x-atom.form-input-standar wire:model="form.lapangan_lokasi" placeholder="Lokasi audit" />
                            <x-atom.form-error-input :kolom="'form.lapangan_lokasi'" />
                        </div>
                    </div>

                    <div class="flex border-b border-40">
                        <div class="w-1/4 py-4">
                            <h4 class="font-normal text-80">Tanggal audit</h4>
                        </div>
                        <div class="w-3/4 py-4 break-words">
                            <x-atom.form-input-standar type="date" wire:model="form.lapangan_tanggal"
                                placeholder="Tanggal audit" />
                            <x-atom.form-error-input :kolom="'form.lapangan_tanggal'" />
                        </div>
                    </div>
                    ...
                    <div class="flex border-b border-40">
                        <div class="w-1/12 p-4 flex justify-between">
                            ...
                            <span>
                                @if ($item->jawabanable_type=='App\Models\SubUraian') {{$item->jawabanable->nomor}}.
                                @endif
                            </span>
                        </div>
                        <div class="w-6/12 py-4 break-words">
                    ...
                    <div class="flex border-b border-40 bg-green-50 justify-between items-center">
                        ...
                        <div class="w-9/12 p-4 break-words">
                            <x-atom.form-input-standar wire:model="jawabans.{{$index}}.deskripsi"
            ...
            <div class="flex justify-end space-x-2">
                ...
                <x-atom.button-link class="p-2" :color="'zinc'" href="{{ route('auditorAmidokumen') }}">
                    Kembali
                </x-atom.button-link>
            </div>
